        ...
        <div className="row mb-1">
          <div className="col-lg-2 col-md-6 col-12">
            <div className="ftco-footer-widget mb-4">
              ...
              <ul className="ftco-footer-social list-unstyled float-md-left float-lft mt-5 p-1">
          ...
          <div className="col-lg-3 col-md-6 col-12">
            <div className="ftco-footer-widget mb-4">
            	...
            	<div className="block-23 mb-3">
	              <ul>
	                <li><span className="icon icon-map-marker"></span><span className="text">A-43, Ducat Noida , Sector-16,UP, Noida-201351,UP</span></li>
	                <li><Link to="#"><span className="icon icon-phone"></span><span className="text">+94839483943</span></Link></li>
	                <li><Link to="#"><span className="icon icon-envelope"></span><span className="text">vishankchauhan@.com</span></Link></li>
	              </ul>
	            </div>
            </div>
          </div>
