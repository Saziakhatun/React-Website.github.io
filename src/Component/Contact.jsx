                        ...
                        <div className="col-md-6 order-md-last">
                            {
                                ...
                                <strong>Thanks to Share Your Query With Us!!!</strong>   Our Team Will Contact You Soon !!!
                            ...
                            <form onSubmit={postData} className="bg-white p-5 contact-form">
                                ...
                                <div className="form-group">
                                    <input type="number" className="form-control" name="phone" onChange={getData} placeholder="Phone" />
                                </div>
                                <div className="form-group">
                                    <input type="text" className="form-control" name="subject" onChange={getData} placeholder="Subject" />
                                </div>
                                <div className="form-group">
                                    <textarea rows="7" name="message" onChange={getData} className="form-control" placeholder="Enter Message"></textarea>
                                </div>
                                <div className="form-group">
                        ...
                        <div className="col-md-6">
                            <div className="mapouter">
                                <div className="gmap_canvas">
                                    <iframe width="550" height="550" id="gmap_canvas"
